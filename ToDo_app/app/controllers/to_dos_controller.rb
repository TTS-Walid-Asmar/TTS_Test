class ToDosController < ApplicationController
  before_action :set_to_do, only: [:info, :edit, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @to_do.save
        ...
        format.json { render :info, status: :created, location: @to_do }
      else
  ...
  def update
    respond_to do |format|
      if @to_do.update(to_do_params)
        ...
        format.json { render :info, status: :ok, location: @to_do }
      else
